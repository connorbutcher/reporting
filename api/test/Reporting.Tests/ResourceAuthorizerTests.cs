...
public class ResourceAuthorizerTests : IDisposable
{
    ...
    private ResourceAuthorizer Authorizer(int userId)
    {
        ...
        return new ResourceAuthorizer(_db, permissions, new DatasetRepository(_db, new Reporting.DAL.Formulas.FormulaCalculationService(_db, new Reporting.DAL.Formulas.Catalogue.FormulaFunctionCatalogueLoader(_db))));
    }
